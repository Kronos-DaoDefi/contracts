...
contract sKronosToken is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Staked Kronos", "sKRO", 9) ERC20Permit() {
    ...
    /**
        @notice increases SKronos supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess SKronos
