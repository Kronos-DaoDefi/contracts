...
///@author Zapper
///@notice This contract adds liquidity to Pancake pools on Avalanche using bnb or any ERC20 Tokens.
...
contract KRONOS_ZapIn_V1 is ZapInBaseV3_1 {
    using SafeERC20 for IERC20;
    ...
    constructor(address _DAO)
    {
        ...
        //allowedPairs
        allowedPairs[ITimeBondDepository(0x1d04B3DEC5c8B9cD3BDd6570BE07f838E60cE962)] = 0x8F4306a7B4AF0Ad4b4623e89d5bC80e0A5d45D9e;

        //allowedReserves
        allowedReserves[ITimeBondDepository(0x1B7c09F30CF5392d79955bb06CD8Ec05C782ddF8)] = 0xdB85311CF6F098C112C6899dFF8F83F1D2cfc61C;
    }
    ...
    /**
    @notice Add liquidity to Pancake pools with ETH/ERC20 Tokens and buys Time Bond
    ...
    function ZapInLp(
        ...
        cache.balanceAfter = _FromTokenContractAddress == address(0) 
            ? IERC20(wbnbTokenAddress).balanceOf(address(this))
            : IERC20(_FromTokenContractAddress).balanceOf(address(this));
